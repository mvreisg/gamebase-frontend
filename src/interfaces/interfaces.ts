...
export interface LoginFormPasswordVisibilityButtonContext
    extends LoginFormContext {
    setVisibility(value: PasswordVisibility): void;
    getVisibility(): PasswordVisibility;
}
...
export interface TextInputWarningParagraphElementParameters
    extends ElementParameters {
    text: string;
}
...
export interface TextInputWarningParagraphElementProperties
...
export interface PasswordVisibilityButtonElementProperties
    extends ElementProperties {
    methods: {
        setSvg(): void;
    };
